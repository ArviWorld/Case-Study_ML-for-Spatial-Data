...
confusion_matrices <- list(
  Random_Forest = cm_plot_xrf,
  XGBoost = cm_plot_xgb,
  SVM = cm_plot_svm
)

# Plot the matrices side by side
grid.arrange(grobs = confusion_matrices, ncol = 3)

# Easy side-by-side layout
p1 + p2 + p3 
...
# Create a data frame to hold the scoring metrics for each model

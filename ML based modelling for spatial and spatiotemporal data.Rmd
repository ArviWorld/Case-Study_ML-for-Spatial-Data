...
ggplot(scoring_df, aes(x = Model)) +
  ...
  geom_bar(aes(y = Specificity, fill = "Specificity"), stat = "identity", position = "dodge") +
  geom_bar(aes(y = F1_Score, fill = "F1 Score"), stat = "identity", position = "dodge") +
  labs(title = "Comparison of Scoring Metrics for Each Model",
       x = "Model",
       y = "Score") +

...
explainer <- list(explainer_rf, explainer_xgb, explainer_svm)
...
plot_spatial_predictions(predictions_rf, sentinel, "Random Forest")
plot_spatial_predictions(predictions_xgb, sentinel, "XGBoost")
plot_spatial_predictions(predictions_svm, sentinel, "SVM")

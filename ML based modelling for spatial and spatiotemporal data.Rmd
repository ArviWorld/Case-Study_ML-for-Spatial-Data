...
kable(confusion_rf$table, caption = "Confusion Matrix for Random Forest Model") %>%
  kable_styling(full_width = F, position = "left")
...
ggplot(as.data.frame(confusion_rf$table), aes(x = Reference, y = Prediction)) +
...
kable( model_xgb$bestTune, caption = "Best Hyperparameters for XGBoost Model") %>%
  kable_styling(full_width = F, position = "left")
...
# Print confusion matrix
kable(confusion_xgb$table, caption = "Confusion Matrix for XGBoost Model") %>%
  kable_styling(full_width = F, position = "left")

# Plot confusion matrix
ggplot(as.data.frame(confusion_xgb$table), aes(x = Reference, y = Prediction)) +
  geom_tile(aes(fill = Freq), color = "white") +
  scale_fill_gradient(low = "white", high = "steelblue") +
  geom_text(aes(label = Freq), color = "black") +
...
# Plot confusion matrix
ggplot(as.data.frame(confusion_svm$table), aes(x = Reference, y = Prediction)) +
  geom_tile(aes(fill = Freq), color = "white") +
  scale_fill_gradient(low = "white", high = "steelblue") +
  geom_text(aes(label = Freq), color = "black") +
...
# Print confusion matrix
kable(confusion_svm$table, caption = "Confusion Matrix for Support Vector Machine Model") %>%
  kable_styling(full_width = F, position = "left")
